...
class NGswin(nn.Module):
    ...
    Args:
        ...
        target_mode (str): light_x1, light_x3, light_x4.  Default: light_x1
    ...
    def __init__(
        ...
        in_chans=1, embed_dim=64, depths=(6,4,4), num_heads=(6,4,4), head_dim=None,
        ...
        _assert(target_mode in ['light_x1', 'light_x3', 'light_x4'], 
                "'target mode' should be one of ['light_x1', 'light_x3', 'light_x4']")
